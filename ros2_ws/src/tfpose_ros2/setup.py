...
EXT = Extension('_pafprocess',
                sources=[
                    'tfpose_ros2/pafprocess/pafprocess_wrap.cpp',
                    'tfpose_ros2/pafprocess/pafprocess.cpp',
                ],
                swig_opts=['-c++'],
...
setuptools.setup(
    ...
    entry_points={
        'console_scripts': [
            'get_pose_service = tfpose_ros2.node_get_pose_service:main',
        ],
    },
)
